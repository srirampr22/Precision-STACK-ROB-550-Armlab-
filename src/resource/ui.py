...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        #newbutton for block detection
        self.radioUsr3 = QtWidgets.QRadioButton(self.centralwidget)
        self.radioUsr3.setObjectName("radioUsr3")
        ...
        self.DetectedBlock = QtWidgets.QLabel(self.centralwidget)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.DetectedBlock.setFont(font)
        self.DetectedBlock.setObjectName("DetectedBlock")
        self.DetectedBlock.setTextFormat(QtCore.Qt.AutoText)
        self.horizontalLayout_2.addWidget(self.DetectedBlock)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioUsr2.setText(_translate("MainWindow", "Calibrated View"))
        self.radioUsr3.setText(_translate("MainWindow", "Block Detection"))
        ...
        self.DetectedBlock.setText(_translate("MainWindow", "Block Detection :"))
